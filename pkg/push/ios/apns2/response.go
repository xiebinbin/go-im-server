...
const (
	...
	// ReasonBadCertificateEnvironment 403 The client certificate was for
	//the wrong environment.
	ReasonBadCertificateEnvironment = "BadCertificateEnvironment"

	// ReasonExpiredProviderToken 403 The provider token is stale and
	...
	// ReasonInvalidProviderToken 403 The provider token is not valid or
	//the token signature could not be verified.
	ReasonInvalidProviderToken = "InvalidProviderToken"

	// ReasonMissingProviderToken 403 No provider certificate was used to
	//connect to APNs and Authorization
