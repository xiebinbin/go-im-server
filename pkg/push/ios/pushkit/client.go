...
const (
	...
	HostProduction  = "https://api.push.apple.com:443"
)
...
// Development sets the Client to use the APNs development forward endpoint.
func (c *Client) Development() *Client {
	c.Host = HostDevelopment
	return c
}

// Production sets the Client to use the APNs production forward endpoint.
...
func (c *Client) PushWithContext(ctx Context, n *Notification) (*Response, error) {
	...
	fmt.Println("apns response :", response)
	return response, nil
}
